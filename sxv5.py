...
class CameraThread(QThread):
    ...
    def __init__(self):
        ...
        try:
            ...
            preview_config = self.picam2.create_preview_configuration(main={"size": (1640, 1232)})
            self.picam2.configure(preview_config)
            self.picam2.start()
            print("Picamera2 initialized successfully")
            self.cap = None  # We don't need cv2.VideoCapture anymore
    ...
    def run(self):
        ...
        self.running = True
        if self.picam2 is None: # Exit if camera failed to initialize
            self.running = False
        ...
        while self.running:
            try:
                ...
                print(f"Warning: Error capturing frame: {e}. Retrying...")
                self.msleep(50)
                continue
    ...
    def stop(self):
        ...
        if self.picam2:
            self.picam2.stop()
            print("CameraThread: Camera stopped.")
